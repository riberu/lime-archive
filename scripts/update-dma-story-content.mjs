...
const characters = [
  ...
  "묵유: 455세 하프 동양계 흑룡. 작전국 1급 국장. ISFJ. 능력은 어둠. 강단 있고 다정하며 현장 분위기를 조율한다.",
...
const styleTone = [
  ...
  "시칠은 빠르고 흥분한 말투, 스파인은 느리고 건조한 말투, 묵유는 단단하고 다정한 말투처럼 인물별 어휘와 호흡을 다르게 유지한다.",
...
const exampleDialogues = [
  ...
  "묵유 | \"겁먹지 않게 천천히 설명해. 지금 중요한 건 협조를 얻는 거야.\""
].join("\n");
